...
enum key {
	...
	PREW_TAB,          // go to the previous tab
	NEXT_TAB,          // go to the next tab
	PREW_APP,          // go to the previous app
...
// ячсми тьбю/
	...
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	    LCTL_T(KC_A), LOPT_T(KC_S), LSFT_T(KC_D), LCMD_T(KC_F),         KC_G,            KC_H, RCMD_T(KC_J), RSFT_T(KC_K), ROPT_T(KC_L),RCTL_T(KC_SCLN),
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	...
	[MEDIA] = LAYOUT(
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	           KC_NO,        KC_NO,        KC_NO,        KC_NO,        KC_NO,           KC_NO,        KC_NO,        KC_NO,        KC_NO,        KC_MPLY,
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	...
	[NAV] = LAYOUT(
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	        HIS_BACK,     HIS_FORW,     PREW_TAB,     NEXT_TAB,     SCR_TO_B,   RCMD(KC_BSPC),RSFT(KC_LEFT),RSFT(KC_DOWN),  RSFT(KC_UP),  RSFT(KC_RGHT),
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	  LCTL_T(KC_TAB),      KC_LOPT,      KC_LSFT,      KC_LCMD,     SCR_TO_F,   RCMD(KC_LEFT),      KC_LEFT,      KC_DOWN,        KC_UP,        KC_RGHT,
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	        PREW_APP,     NEXT_APP,     PREW_SPC,     NEXT_SPC,        VIDEO,   ROPT(KC_BSPC),ROPT(KC_LEFT),ROPT(KC_DOWN),  ROPT(KC_UP),  ROPT(KC_RGHT),
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|

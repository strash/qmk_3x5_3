...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+-------------|
									TD(ESC_LANG), T_BASE_H_NAV,       KC_SPC,          KC_ENT,T_MEDIA_H_SYM,      KC_BSPC \
								//|-------------+-------------+-------------|  |-------------+-------------+-------------|
	),
	...
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
								          KC_ESC, T_BASE_H_NAV,       KC_SPC,          KC_ENT,T_MEDIA_H_SYM,LSFT_T(KC_BSPC) \
								//|-------------+-------------+-------------|  |-------------+-------------+-------------|
	),
	...
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
								    TD(ESC_LANG),         BASE,       KC_SPC,          KC_ENT,       TO(FN),      KC_BSPC \
								//|-------------+-------------+-------------|  |-------------+-------------+-------------|
	),
	...
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
									TD(ESC_LANG),         BASE,       KC_SPC,          KC_ENT,       TG(FN),      KC_BSPC \
								//|-------------+-------------+-------------|  |-------------+-------------+-------------|
	),
    ...
    [NAV] = LAYOUT( \
        ...
        //|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
										TD(ESC_LANG),        KC_NO,       KC_SPC,          KC_ENT,        KC_NO,      KC_BSPC \
									//|-------------+-------------+-------------|  |-------------+-------------+-------------|
        ),

...
// sym hold
#define SYM_HOLD LT(SYM, KC_R)
// sym hold qwerty
#define SYM_HOLD_QWE LT(SYM, KC_BSPC)
...
const uint16_t PROGMEM kyou_caps_word_combo[] = {LSFT_T(KC_A), RSFT_T(KC_S), COMBO_END};
const uint16_t PROGMEM qwe_caps_word_combo[] =  {LSFT_T(KC_F), RSFT_T(KC_J), COMBO_END};
...
combo_t key_combos[] = {
	[XYOU_CAPS_WORD] =     COMBO(kyou_caps_word_combo, CW_TOGG),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[KYOU] = LAYOUT( \
	//|--------+------+-------------+-------------+-------------+---------------|  |---------------+-------------+-------------+-------------+--------+--------|
      XXXXXXX,  KC_K,         KC_Y,         KC_O,         KC_U,        KC_QUOT,              KC_Z,         KC_C,         KC_D,         KC_P,    KC_M, XXXXXXX, \
	//|--------+------+-------------+-------------+-------------+---------------|  |---------------+-------------+-------------+-------------+--------+--------|
      XXXXXXX,  KC_H, LOPT_T(KC_I), LCMD_T(KC_E), LSFT_T(KC_A),        KC_MINS,              KC_G, RSFT_T(KC_S), RCMD_T(KC_T), ROPT_T(KC_N),    KC_L, XXXXXXX, \
	//|--------+------+-------------+-------------+-------------+---------------|  |---------------+-------------+-------------+-------------+--------+--------|
      XXXXXXX,  KC_J,         KC_Q,      KC_COMM,       KC_DOT,        KC_SCLN,              KC_X,         KC_W,         KC_B,         KC_F,    KC_V, XXXXXXX, \
	//|--------+------+-------------+-------------+-------------+---------------|  |---------------+-------------+-------------+-------------+--------+--------|
	...
	//|--------+------+-------------+-------------+-------------+--------|  |--------+---------------+------------------+-------------+------------------+--------|
	    XXXXXXX,  KC_A, LOPT_T(KC_S), LCMD_T(KC_D), LSFT_T(KC_F),    KC_G,       KC_H,   RSFT_T(KC_J),      RCMD_T(KC_K), ROPT_T(KC_L),           KC_SCLN, XXXXXXX, \
	//|--------+------+-------------+-------------+-------------+--------|  |--------+---------------+------------------+-------------+------------------+--------|
	    XXXXXXX,  KC_Z,         KC_X,         KC_C,         KC_V,    KC_B,       KC_N, TD(QWE_M_LBRC), TD(QWE_COMM_RBRC),       KC_DOT, TD(QWE_SLSH_BSLS), XXXXXXX, \
	//|--------+------+-------------+-------------+-------------+--------|  |--------+---------------+------------------+-------------+------------------+--------|
							  												 XXXXXXX,     NAV_HOLD,  KC_SPC,     KC_ENT,   SYM_HOLD_QWE,           XXXXXXX \
																//|-------------+-------------+--------|  |--------+---------------+------------------|
	),
	...
	//|-------+-------------+----------+----------+----------+--------------|  |-------------+--------------+--------------+------------+--------------+--------|
	   XXXXXXX, LSFT(KC_TAB),    KC_TAB,   KC_LCMD,   KC_LSFT, LOPT(KC_BSPC),         KC_BSPC,       KC_LEFT,       KC_DOWN,       KC_UP,       KC_RGHT, XXXXXXX, \
	//|-------+-------------+----------+----------+----------+--------------|  |-------------+--------------+--------------+------------+--------------+--------|
	...
	[SYM] = LAYOUT( \
	//|-------+---------+---------+---------+---------+---------|  |---------+---------+---------+--------+---------+--------|
	   XXXXXXX,  KC_PIPE,  KC_AMPR,  KC_LCBR,  KC_RCBR,  KC_DLR,      KC_PERC,  KC_RPRN,  KC_LPRN,   KC_AT,  KC_HASH, XXXXXXX, \
	//|-------+---------+---------+---------+---------+---------|  |---------+---------+---------+--------+---------+--------|
	   XXXXXXX,    KC_P1,    KC_P2,    KC_P3,    KC_P4,    KC_P5,       KC_P6,    KC_P7,    KC_P8,   KC_P9,    KC_P0, XXXXXXX, \
	//|-------+---------+---------+---------+---------+---------|  |---------+---------+---------+--------+---------+--------|
	   XXXXXXX,  KC_TILD,  KC_CIRC,  KC_EXLM,  KC_QUES,  KC_PLUS,     KC_SLSH,  KC_RBRC,  KC_LBRC,  KC_GRV,  KC_BSLS, XXXXXXX, \
	//|-------+---------+---------+---------+---------+---------|  |---------+---------+---------+--------+---------+--------|
																	 XXXXXXX,  KC_ASTR,   KC_EQL,     XXXXXXX,  XXXXXXX,  XXXXXXX \
															//|---------+---------+---------|  |---------+---------+---------|
	),
    ...
    switch (keycode) {
		case BASE:
			if (record->event.pressed) {
				default_layer_xor((KYOU + 1) | (QWE + 1));
